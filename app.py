        ...
        if not col_name or not col_phone:
            ...
            with tab_tripoli:
                ...
                if selected_user_t != "-- اختر اسماً --":
                    ...
                    with col4: st.markdown(f'<a href="{url_tripoli_bus}" target="_blank"><button style="background-color: #ff9800; color: white; border: none; padding: 12px 5px; border-radius: 6px; font-size: 13px; width: 100%;">🚌
