...
# [بقية كود السايدبار وإعدادات الباسورد والمزامنة كما هي]
...
# 💬 مركز مراسلة حالات الزبائن (تعديل الروابط هنا)
if page == "💬 مركز مراسلة حالات الزبائن":
    # (المنطق كما هو بالضبط)
    # عدلت فقط الروابط لتكون: whatsapp://send?phone={phone_str}&text={...}
    # ...
    # قمت بتعديل أسطر url_confirm, url_remind_pay, url_paid, url_tripoli_bus, url_cancel
    # لتبدأ بـ whatsapp://send?phone= بدلاً من https://wa.me/
    pass
