        ...
        if not col_name or not col_phone:
            ...
            if selected_user:
                ...
                msg_tripoli_bus = (
                    ...
                    f"1. يرجى الالتزام التام والمطلق بوقت التجمع، نظراً لأن الحافلة مرتبطة بجدول زمني طويل لقطع المسافة، ولن نتمكن من الانتظار حفاظاً على راحة العائلات الحاضرة in الموعد.\n"
...
# ----------------------------------------------------
    ...
    if 'df' in st.session_state:
        ...
        if col_region:
            ...
            # 🟢 تم إصلاح القوس المنقطع هنا ليعود السطر سليماً تماماً ومغلقاً
