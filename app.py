...
# ----------------------------------------------------
    ...
    if 'df' in st.session_state:
        ...
        # ✅ تم إرجاع عرض كافة الأعمدة والأسعار والقيم كاملة هنا بدون قص
...
# ----------------------------------------------------
    ...
    if 'df' in st.session_state:
        ...
        if col_hotel:
            ...
            # ✅ تم إرجاع الكشف كاملاً بكافة تفاصيله وقيمه المالية المعتمدة
...
# ----------------------------------------------------
    ...
    if 'df' in st.session_state:
        ...
        if col_hotel:
            ...
            # ✅ تم إرجاع الأعمدة كاملة بدون أي حظر للأسعار
...
# ----------------------------------------------------
    ...
    if 'df' in st.session_state:
        ...
        if col_region:
            ...
            # ✅ تم تأمين وإغلاق القوس لعرض الكشف كاملاً دون تصفية أعمدة
...
# ----------------------------------------------------
    ...
    if 'df' in st.session_state:
        ...
        if col_region:
            ...
            # ✅ الكشف يعرض البيانات المالية الكاملة وعدد الأفراد
