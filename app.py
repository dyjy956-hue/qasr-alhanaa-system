    ...
    if 'df' in st.session_state:
        ...
        if not col_name or not col_phone:
            ...
            if selected_user:
                ...
                with col3: st.markdown(f'<a href="{url_paid}"><button style="background-color: #25D366; color: white; border: none; padding: 12px 5px; border-radius: 6px; font-size: 13px; cursor: pointer;
